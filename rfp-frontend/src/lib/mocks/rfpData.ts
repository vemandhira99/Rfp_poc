export type RFPStatus = 'new' | 'in-progress' | 'pending-review' | 'pending-approval' | 'approved' | 'rejected' | 'on-hold' | 'on_hold' | 'queued_for_processing' | 'processing_summary' | 'assigned_to_sa' | 'in_drafting' | 'under_review' | 'summary_generated' | 'error' | 'rate_limit_error'
