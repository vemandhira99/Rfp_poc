...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    const user = role === 'architect'
      ? { id: 'u2', name: 'Alex Johnson', initials: 'SA', role: 'architect', email: emailInput || 'alex@company.com' }
      : { id: 'u1', name: 'Jennifer Smith', initials: 'PM', role: 'pm', email: emailInput || 'jennifer@company.com' }
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input 
                id="email" 
                type="email" 
                placeholder={role === 'pm' ? 'jennifer@company.com' : 'alex@company.com'} 
                required 
